    ...
    <div class="card-text">
      ...
      <form method="POST" action="server.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control form-control-sm" name="c_password" id="exampleInputPassword1">
        </div>
       <input type="submit" name="register" value="Login" class="btn btn-danger btn-block">        
        <div class="sign-up">
          <?php if (isset($_GET['er'])) { ?> <label style="color: red;"> <?php echo $_GET['er']; ?></label> <br><?php } ?>
          Already have an account? <a href="login.php" class="text text-danger">Login</a>
        </div>
      </form>
    </div>
  </div>
